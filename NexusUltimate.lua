...
{Name="Pet Simulator 99",        LS=[[ loadstring(game:HttpGet("PASTE PET SIM 99 LINK HERE",true))() ]]},
{Name="Doors",                   LS=[[ loadstring(game:HttpGet("PASTE DOORS LINK HERE",true))() ]]},
{Name="Murder Mystery 2",        LS=[[ loadstring(game:HttpGet("PASTE MM2 LINK HERE",true))() ]]},
{Name="Arsenal",                 LS=[[ loadstring(game:HttpGet("PASTE ARSENAL LINK HERE",true))() ]]},
{Name="Rivals",                  LS=[[ loadstring(game:HttpGet("PASTE RIVALS LINK HERE",true))() ]]},
{Name="Jujutsu Kaisen",          LS=[[ loadstring(game:HttpGet("PASTE JJK LINK HERE",true))() ]]},
{Name="Sols RNG",                LS=[[ loadstring(game:HttpGet("PASTE SOLS RNG LINK HERE",true))() ]]},
{Name="Grow Garden",             LS=[[ loadstring(game:HttpGet("PASTE GROW GARDEN LINK HERE",true))() ]]},
{Name="Blade Ball",              LS=[[ loadstring(game:HttpGet("PASTE BLADE BALL LINK HERE",true))() ]]},
{Name="Bloxflip",                LS=[[ loadstring(game:HttpGet("PASTE BLOXFLIP LINK HERE",true))() ]]},
{Name="Anime Defenders",         LS=[[ loadstring(game:HttpGet("PASTE ANIME DEF LINK HERE",true))() ]]},
{Name="Anime Last Stand",        LS=[[ loadstring(game:HttpGet("PASTE ANIME LS LINK HERE",true))() ]]},
{Name="Demonfall",               LS=[[ loadstring(game:HttpGet("PASTE DEMONFALL LINK HERE",true))() ]]},
{Name="Project Slayers",         LS=[[ loadstring(game:HttpGet("PASTE PROJ SLAYERS LINK HERE",true))() ]]},
{Name="Deepwoken",               LS=[[ loadstring(game:HttpGet("PASTE DEEPWOKEN LINK HERE",true))() ]]},
{Name="Type Soul",               LS=[[ loadstring(game:HttpGet("PASTE TYPE SOUL LINK HERE",true))() ]]},
{Name="Untitled Boxing Game",    LS=[[ loadstring(game:HttpGet("PASTE BOXING LINK HERE",true))() ]]},
{Name="Strongest Battlegrounds", LS=[[ loadstring(game:HttpGet("PASTE STRONGEST BG LINK HERE",true))() ]]},
{Name="Brookhaven RP",           LS=[[ loadstring(game:HttpGet("PASTE BROOKHAVEN LINK HERE",true))() ]]},
{Name="Adopt Me",                LS=[[ loadstring(game:HttpGet("PASTE ADOPT ME LINK HERE",true))() ]]},
{Name="Piggy",                   LS=[[ loadstring(game:HttpGet("PASTE PIGGY LINK HERE",true))() ]]},
...
{Name="King Legacy",             LS=[[ loadstring(game:HttpGet("PASTE KING LEGACY LINK HERE",true))() ]]},
{Name="Grand Piece Online",      LS=[[ loadstring(game:HttpGet("PASTE GPO LINK HERE",true))() ]]},
{Name="Fisch",                   LS=[[ loadstring(game:HttpGet("PASTE FISCH LINK HERE",true))() ]]},
{Name="Lumber Tycoon 2",         LS=[[ loadstring(game:HttpGet("PASTE LUMBER TYCOON 2 LINK HERE",true))() ]]},
}
